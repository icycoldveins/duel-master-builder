...
export const themeClasses = {
  // Border styles
  cardFrame: 'millennium-border bg-gradient-card border border-border rounded-lg transition-all duration-300',
  ...
  // Layout utilities
  gridContainer: 'grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 p-4',
  flexCenter: 'flex items-center justify-center',
  
  // Animation utilities
  hoverScale: 'transition-all duration-300 hover:scale-105 hover:-translate-y-2',
