          ...
          stats.sideCount <= 15 ? (
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Your deck meets all competitive requirements
                </p>
              </div>
            </div>
          ) : (
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {stats.mainCount < 40 &&
                    `Main deck needs ${40 - stats.mainCount} more cards. `}
                  {stats.mainCount > 60 &&
                    `Main deck has ${stats.mainCount - 60} too many cards. `}
                  {stats.extraCount > 15 &&
                    `Extra deck has ${stats.extraCount - 15} too many cards. `}
                  {stats.sideCount > 15 &&
                    `Side deck has ${stats.sideCount - 15} too many cards.`}
                </p>
              </div>
            </div>
          )}
