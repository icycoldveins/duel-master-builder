...
export function DeckBuilder() {
  ...
  const handleSetUsername = async (e) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: err.message || "Could not set username.",
        variant: "destructive",
      });
    } finally {
      setChecking(false);
      ...
      <Dialog open={showUsernameDialog}>
        <DialogContent>
          ...
          <form onSubmit={handleSetUsername} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={checking || !!usernameError || !username}
              className="w-full"
            >
        ...
        <div className="container mx-auto p-4 relative z-10">
          ...
          <div className="text-center space-y-6 py-12 animate-fade-in">
            <div className="relative inline-block">
              <img
                src="/millennium-puzzle.png"
                alt="Millennium Puzzle Logo"
                style={{ display: "inline-block", width: 100, height: 100 }}
                className="mx-auto mb-6 logo-glow animate-glow-pulse"
              />
            ...
            <p className="text-muted-foreground text-xl max-w-3xl mx-auto leading-relaxed">
              Build competitive decks with the latest card database and
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div className="xl:col-span-3">
              <div
                className="glass-dark rounded-3xl p-6 shadow-2xl sticky top-4 animate-slide-in border border-white/10 hover:border-accent/30 transition-all duration-500"
