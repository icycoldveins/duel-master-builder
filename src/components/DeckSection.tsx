...
export function DeckSection({
  ...
  const isValid = minCards
    ? totalCards >= minCards && totalCards <= limit
    : totalCards <= limit;
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div
                className={`px-5 py-3 rounded-2xl backdrop-blur-lg border transition-all duration-300
            ...
            <span className="font-medium">
              {totalCards > limit && (
                <span className="text-destructive animate-pulse">
                  Over limit by {totalCards - limit}!
                </span>
              )}
